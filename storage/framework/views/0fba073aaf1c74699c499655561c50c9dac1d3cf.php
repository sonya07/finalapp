...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">LEGACY Guests</div>
                ...
                <div class="card-body">
                    ...
                    <?php $__currentLoopData = $guests2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $guest): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class = "row">
                            <div class="form-check">
                                <input name="ch []" class="form-check-input" type="checkbox" id="<?php echo e($guest->year); ?>">
                                <label class ="form-check-label">
                                    <?php echo e($guest->year); ?>-
                                </label>
                                <label class ="form-check-label">
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <button type="submit" class="btn btn-primary">Export LEGACY</button>
                    </form>
                    </div>
                </div>
            </div>
